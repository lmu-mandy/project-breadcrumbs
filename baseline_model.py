...
"""Define GPT-2 baseline model (without fine-tuning on fairy tale training data) and evaluating model on fairy tale test data."""
...
# The line below would be used in order to fine-tune the model on the fairy tale data.
# baseline_model.train_model('train.txt', eval_file='test.txt')

baseline_model.eval_model('test.txt')

"""Generate fairy tale text from baseline GPT-2 model."""

from simpletransformers.language_generation import LanguageGenerationModel

# Generate fairy tale on baseline model (not fine-tuned on fairy tale data).
baseline_generator = LanguageGenerationModel('gpt2', 'gpt2', args={'max_length': 256})

# The line below would be used to generate text from a fine-tuned model.
...
for prompt in prompts:
    generated = baseline_generator.generate(prompt, verbose=False)
