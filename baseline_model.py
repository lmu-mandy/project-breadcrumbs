...
This notebook uses GPT-2 from simpletransformers to generate fairy tale text. For our baseline model, the model is not fine-tuned, but is then tested on fairy tale data from the Blue Fairy Book.
"""
...
"""The Blue Fairy Book is read and split into training and testing data."""

import pandas as pd

df = pd.read_csv('bfb.txt', delimiter="\t", encoding='utf-8', header=None, names=['Line'])
